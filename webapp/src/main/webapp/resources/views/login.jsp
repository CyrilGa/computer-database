	...
	<section id="main">
		<div class="container-login-main">
			...
			<form id="searchForm" action="/cdb/LoginProcess" method="POST">
				<h1><spring:message code="string.login.title"/></h1>
				<fieldset>
					<div class="form-group">
						<label for="username">
							<spring:message code="string.login.username"/>
						</label>
					...
					<div class="form-group">
						<label for="password">
							<spring:message code="string.login.password"/>
						</label>
				...
				<div class="actions pull-right">
					<input type="submit" id="btnSubmit" value="<spring:message code="string.submit"/>"
