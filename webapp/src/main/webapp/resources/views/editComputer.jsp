		...
		<div class="container">
			<div class="row">
				<div class="col-xs-8 col-xs-offset-2 box">
					...
					<form:form id="validForm" action="/cdb/editComputer" method="POST"
						...
						<fieldset>
							<div class="form-group">
								...
								<form:input type="text" class="form-control" id="computerName"
									name="computerName" placeholder="Computer name" value="${name}"
									path="computerName" />
							</div>
							<div class="form-group">
								...
								<div class="form-inline">
									<form:input type="date" class="form-control"
										...
										value="${introducedDate}" min="0000-01-01" max="9999-01-01"
										path="introducedDate" />
						...
						<div class="actions pull-right">
							<input type="submit" id="btnSubmit"
								value="<spring:message code="string.edit"/>"
